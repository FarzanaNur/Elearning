                            ...
                            <div class="hero__caption hero__caption2">
                                ...
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="{{url('course')}}">Contact</a></li> 
                                    </ol>
                                </nav>
                                <!-- breadcrumb End -->
                            </div>
    ...
    <section class="contact-section">
        <div class="container">
            ...
            <div class="row" align="center">
                <div class="col-12">
                    <h2 class="contact-title">My courses</h2>
                </div>
                ...
                <div class="properties pb-20">
                        <div class="properties__card">
                            ...
                            <div class="properties__caption">
                                <!-- <p>User Experience</p> -->
                                <h3><a href="#">Laravel for beginner</a></h3>
                                <div class="properties__footer d-flex justify-content-between align-items-center">
                                    <div class="restaurant-name">
                                        ...
                                        <p style="text-align:center ;">You've successfully enrolled to laravel course.Further information will be mailed to you.Please keep an eye on that.</p>
